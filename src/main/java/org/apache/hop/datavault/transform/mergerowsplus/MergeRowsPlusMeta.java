...
@Transform(
    id = "MergeRowsPlus",
    image = "mergerowsplus.svg",
    name = "i18n::MergeRowsPlus.Name",
    description = "i18n::MergeRowsPlus.Description",
    categoryDescription = "i18n:org.apache.hop.pipeline.transform:BaseTransform.Category.Joins",
    keywords = "i18n::MergeRowsPlusMeta.keyword",
    documentationUrl = "/pipeline/transforms/mergerowsplus.html")
public class MergeRowsPlusMeta extends BaseTransformMeta<MergeRowsPlus, MergeRowsPlusData> {
  private static final Class<?> PKG = MergeRowsPlusMeta.class;

  @HopMetadataProperty(
      key = "flag_field",
      injectionKey = "FLAG_FIELD",
      injectionKeyDescription = "MergeRowsPlus.Injection.FLAG_FIELD")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "MergeRowsPlus.Injection.KEY_FIELD",
      injectionGroupDescription = "MergeRowsPlus.Injection.KEY_FIELDS")
  ...
  @HopMetadataProperty(
      ...
      injectionKeyDescription = "MergeRowsPlus.Injection.VALUE_FIELD",
      injectionGroupDescription = "MergeRowsPlus.Injection.VALUE_FIELDS")
  private List<String> valueFields;

  @HopMetadataProperty(
      key = "reference",
      injectionKey = "REFERENCE_TRANSFORM",
      injectionKeyDescription = "MergeRowsPlusMeta.InfoStream.FirstStream.Description")
  private String referenceTransform;

  @HopMetadataProperty(
      key = "compare",
      injectionKey = "COMPARE_TRANSFORM",
      injectionKeyDescription = "MergeRowsPlusMeta.InfoStream.SecondStream.Description")
  private String compareTransform;

  @HopMetadataProperty(
      key = "diff-field",
      injectionKey = "DIFF_FIELD",
      injectionKeyDescription = "MergeRowsPlus.Injection.DIFF_FIELD")
  private String diffJsonField;

  @HopMetadataProperty(key = "align_input_layouts")
  ...
  @HopMetadataProperty(
      ...
      injectionGroupDescription = "MergeRowsPlus.Injection.PASSTHROUGH_FIELDS",
      injectionKey = "PASSTHROUGH_FIELD",
      injectionKeyDescription = "MergeRowsPlus.Injection.PASSTHROUGH_FIELD")
  private List<PassThroughField> passThroughFields;

  public MergeRowsPlusMeta() {
    super();
  ...
  public MergeRowsPlusMeta(MergeRowsPlusMeta m) {
    this();
  ...
  @Override
  public MergeRowsPlusMeta clone() {
    return new MergeRowsPlusMeta(this);
  }
  ...
  public void getFields(
    ...
    if (Utils.isEmpty(flagField)) {
      throw new HopTransformException(
          BaseMessages.getString(PKG, "MergeRowsPlusMeta.Exception.FlagFieldNotSpecified"));
    }
  ...
  public void check(
    ...
    if (referenceStream.getTransformName() != null && compareStream.getTransformName() != null) {
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(PKG, "MergeRowsPlusMeta.CheckResult.SourceTransformsOK"),
              transformMeta);
      remarks.add(cr);
      ...
      cr =
          new CheckResult(
              ...
              BaseMessages.getString(PKG, "MergeRowsPlusMeta.CheckResult.SourceTransformsMissing"),
              transformMeta);
      remarks.add(cr);
    } else {
      cr =
    ...
    if (!alignInputLayouts) {
      ...
      try {
        ...
        new CheckResult(
            ...
            BaseMessages.getString(
                PKG, "MergeRowsPlusMeta.CheckResult.ErrorGettingPrevTransformFields"),
            transformMeta);
      }
      if (referenceRowMeta != null && compareRowMeta != null) {
        boolean rowsMatch = false;
        try {
          MergeRowsPlus.checkInputLayoutValid(referenceRowMeta, compareRowMeta);
          rowsMatch = true;
        ...
        if (rowsMatch) {
          cr =
              new CheckResult(
                  ICheckResult.TYPE_RESULT_OK,
                  BaseMessages.getString(PKG, "MergeRowsPlusMeta.CheckResult.RowDefinitionMatch"),
                  transformMeta);
          remarks.add(cr);
        } else {
          cr =
      ...
      cr =
          new CheckResult(
              ICheckResult.TYPE_RESULT_OK,
              BaseMessages.getString(PKG, "MergeRowsPlusMeta.CheckResult.AlignmentEnabled"),
              transformMeta);
      remarks.add(cr);
    }
  }
    ...
    if (ioMeta == null) {
      ...
      ioMeta.addStream(
          new Stream(
              StreamType.INFO,
              null,
              BaseMessages.getString(PKG, "MergeRowsPlusMeta.InfoStream.FirstStream.Description"),
              StreamIcon.INFO,
              referenceTransform));
      ioMeta.addStream(
          new Stream(
              StreamType.INFO,
              null,
              BaseMessages.getString(PKG, "MergeRowsPlusMeta.InfoStream.SecondStream.Description"),
              StreamIcon.INFO,
              compareTransform));

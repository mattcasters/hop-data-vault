...
/** Reference-authoritative schema union and row mapping for {@link MergeRowsPlus}. */
public final class MergeRowsPlusAlignment {

  private static final Class<?> PKG = MergeRowsPlusMeta.class;

  private MergeRowsPlusAlignment() {}
      ...
      try {
        ...
        throw new HopTransformException(
            BaseMessages.getString(
                PKG,
                "MergeRowsPlusAlignment.Exception.UnableToConvertCompareField",

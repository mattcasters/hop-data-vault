...
package org.apache.hop.datavault.metrics.xp;
...
/** Registers {@link ExecutionMetricsProfileMeta} with Hop metadata after environment init. */
@ExtensionPoint(
    id = "RegisterExecutionMetricsProfileMetadataExtensionPoint",
    extensionPointId = "HopEnvironmentAfterInit",
    description = "Register Execution Metrics Profile metadata")
public class RegisterExecutionMetricsProfileMetadataExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    IPlugin thisPlugin =
        pluginRegistry.findPluginWithId(
            ...
            "RegisterExecutionMetricsProfileMetadataExtensionPoint");
    ...
    pluginRegistry.registerPluginClass(
        ...
        libraries,
        pluginUrl,
        ExecutionMetricsProfileMeta.class.getName(),

...
@Getter
@Setter
public class DvIcebergSatelliteSourcePipelineBuilder extends DvIcebergSourcePipelineBuilder {
  ...
  public DvIcebergSatelliteSourcePipelineBuilder(
  ...
  protected ColumnMapping buildColumnMapping() throws HopException {
    ...
    return columnMapping(sourceToTarget, icebergSource.getFields());
  }

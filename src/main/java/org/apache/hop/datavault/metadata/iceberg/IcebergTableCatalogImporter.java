...
/** Imports an Iceberg table into the data catalog as a record definition. */
public final class IcebergTableCatalogImporter implements DataCatalogImporter {

  public static final String IMPORTER_ID = "data-catalog-import-iceberg-table";
  ...
  public String getLabelMessageKey() {
    return "IcebergTableCatalogImporter.Label";
  }

  @Override
  public String getTooltipMessageKey() {
    return "IcebergTableCatalogImporter.Tooltip";
  }

  @Override
  public String getImage() {
    return "iceberg-logo.svg";
  }
  ...
  public void execute(DataCatalogImportContext context) {
    DvIcebergSourceImportSupport.importIcebergTable(
        context.getShell(),
        context.getHopGui(),

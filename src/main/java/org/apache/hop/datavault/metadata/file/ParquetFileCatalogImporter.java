...
/** Imports a single Parquet file into the data catalog as a record definition. */
public final class ParquetFileCatalogImporter implements DataCatalogImporter {

  public static final String IMPORTER_ID = "data-catalog-import-parquet-file";
  ...
  public String getLabelMessageKey() {
    return "ParquetFileCatalogImporter.Label";
  }

  @Override
  public String getTooltipMessageKey() {
    return "ParquetFileCatalogImporter.Tooltip";
  }
  ...
  public void execute(DataCatalogImportContext context) {
    DvParquetSourceImportSupport.importParquetFile(
        context.getShell(),
        context.getHopGui(),

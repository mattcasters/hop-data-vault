...
/** Previews and applies validated AI proposals to an open dimensional model. */
public final class DmAiProposalApplier {
  ...
  private static void applyOne(DimensionalModel model, DvAiProposal proposal) throws HopException {
  ...
  private static void addModelNote(DimensionalModel model, DvAiProposal proposal)
      throws HopException {
  ...
  private static void setConfigurationProperty(DimensionalModel model, DvAiProposal proposal)
      throws HopException {
    ...
    DvTargetLoadAiConfigurationSupport.applyToDimensional(config, propertyName, value);
    model.setChanged(true);
  }

  private static void renameTable(DimensionalModel model, DvAiProposal proposal)
      throws HopException {
    ...
    IDmTable table = model.findTable(tableName.trim());
    if (table == null) {

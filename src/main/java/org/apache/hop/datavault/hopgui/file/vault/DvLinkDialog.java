...
public class DvLinkDialog {
  ...
  public boolean open() {
    ...
    wRecordSource =
        new MetaSelectionLine<>(
            ...
            BaseMessages.getString(PKG, "DvLinkDialog.RecordSource.Label"),
            BaseMessages.getString(PKG, "DvLinkDialog.RecordSource.ToolTip"));
    ...
    ColumnInfo[] hubColumns =
        new ColumnInfo[] {
          new ColumnInfo(
              ...
              false),
          new ColumnInfo(
              BaseMessages.getString(PKG, "DvLinkDialog.HubSourceKeyFields.Column"),
              ColumnInfo.COLUMN_TYPE_TEXT,
              false),
        };
  ...
  private void ok() {
    ...
    // input.setRecordSource(wRecordSource.getText()); TODO

...
/** Opens the live update analysis dialog when the workflow badge is double-clicked. */
@ExtensionPoint(
    id = "UpdateRunLiveWorkflowMouseDoubleClickExtensionPoint",
    extensionPointId = "WorkflowGraphMouseDoubleClick",
    description = "Opens live update analysis when the model update badge is double-clicked")
public class UpdateRunLiveWorkflowMouseDoubleClickExtensionPoint
  ...
  public void callExtensionPoint(
    ...
    UpdateRunLiveWorkflowMouseSupport.openDialogIfBadgeClicked(extension);
  }
}
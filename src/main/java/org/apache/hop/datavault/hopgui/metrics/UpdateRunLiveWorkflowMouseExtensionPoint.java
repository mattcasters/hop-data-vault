...
/** Opens the live update analysis dialog when the workflow badge is clicked. */
@ExtensionPoint(
    id = "UpdateRunLiveWorkflowMouseExtensionPoint",
    extensionPointId = "WorkflowGraphMouseUp",
    description = "Opens live update analysis when the model update badge is clicked")
public class UpdateRunLiveWorkflowMouseExtensionPoint

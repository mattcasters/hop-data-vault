...
/** Context handler for clicks on a Data Vault table reference on the Business Vault canvas. */
public class HopGuiBusinessVaultDvReferenceContext extends BaseGuiContextHandler
    implements IGuiContextHandler {

  public static final String CONTEXT_ID = "HopGuiBusinessVaultDvReferenceContext";

  private final BusinessVaultModel model;
  private final HopGuiBusinessVaultGraph businessVaultGraph;
  private final BvDvTableReference reference;
  private final Point click;

  public HopGuiBusinessVaultDvReferenceContext(
  ...
  public List<GuiAction> getSupportedActions() {
    ...
    GuiActionLambdaBuilder<HopGuiBusinessVaultDvReferenceContext> lambdaBuilder =
  ...
  public BvDvTableReference getReference() {
    return reference;
  }

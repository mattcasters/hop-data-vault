...
public class ActionBeginVaultUpdateDialog extends ActionDialog {
  ...
  private final ActionBeginVaultUpdate action;
  ...
  public ActionBeginVaultUpdateDialog(
    ...
    if (Utils.isEmpty(action.getName())) {
      action.setName(BaseMessages.getString(PKG, "ActionBeginVaultUpdate.Name"));
    }
  }
  ...
  public IAction open() {
    ...
    widgets.createCompositeWidgets(
        action, null, wSettingsComp, ActionBeginVaultUpdate.GUI_PLUGIN_ELEMENT_PARENT_ID, null);
    setWidgetsContent();
  ...
  private void getWidgetsContent() {
    ...
    widgets.getWidgetsContents(action, ActionBeginVaultUpdate.GUI_PLUGIN_ELEMENT_PARENT_ID);
  }

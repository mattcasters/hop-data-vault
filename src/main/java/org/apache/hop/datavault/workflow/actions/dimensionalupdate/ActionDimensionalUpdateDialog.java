...
public class ActionDimensionalUpdateDialog extends ActionDialog {
  ...
  private final ActionDimensionalUpdate action;
  private boolean cancelled = true;
  private GuiCompositeWidgets widgets;
  private Composite wModelTabComp;
  private Composite wDdlTabComp;

  public ActionDimensionalUpdateDialog(
      Shell parent,
      ActionDimensionalUpdate action,
    ...
    if (this.action.getName() == null || this.action.getName().isEmpty()) {
      this.action.setName(BaseMessages.getString(PKG, "ActionDimensionalUpdate.Name"));
    }
  }
  ...
  public IAction open() {
    ...
    shell.setText(BaseMessages.getString(PKG, "ActionDimensionalUpdate.Title", action.getName()));
    ...
    wlName.setText(BaseMessages.getString(PKG, "ActionDimensionalUpdate.Name.Label"));
    ...
    wModelTabComp =
        HopGuiDimensionalModelDialog.createTabComposite(
            wTabFolder,
            BaseMessages.getString(PKG, "ActionDimensionalUpdate.Tab.Model.Label"),
            BaseMessages.getString(PKG, "ActionDimensionalUpdate.Tab.Model.ToolTip"));
    wDdlTabComp =
        HopGuiDimensionalModelDialog.createTabComposite(
            wTabFolder,
            BaseMessages.getString(PKG, "ActionDimensionalUpdate.Tab.Ddl.Label"),
            BaseMessages.getString(PKG, "ActionDimensionalUpdate.Tab.Ddl.ToolTip"));
  ...
  private void setWidgetsContent() {
    ...
    widgets.setWidgetsContents(
        action, wModelTabComp, ActionDimensionalUpdate.GUI_PLUGIN_ELEMENT_MODEL_TAB_ID);
    widgets.setWidgetsContents(
        action, wDdlTabComp, ActionDimensionalUpdate.GUI_PLUGIN_ELEMENT_DDL_TAB_ID);
  }

  private void getWidgetsContent() {
    action.setName(wName.getText());
    widgets.getWidgetsContents(action, ActionDimensionalUpdate.GUI_PLUGIN_ELEMENT_MODEL_TAB_ID);
    widgets.getWidgetsContents(action, ActionDimensionalUpdate.GUI_PLUGIN_ELEMENT_DDL_TAB_ID);
  }

...
class WorkflowLoadOverviewPublisherTest {
  ...
  @Test
  void overviewCatalogDefinitionsUseOperationsNamespaceAndTags() throws HopException {
    DatabaseMeta ops = new DatabaseMeta();
    ops.setName("OPS");
    String namespace = "hop/retail-example/operations";

    RecordDefinition overview =
        WorkflowLoadOverviewPublisher.buildOverviewDefinition(namespace, "OPS", "dv_ops", ops);
    ...
    assertEquals("dv_ops", overview.getPhysicalTable().getSchemaName());
  }
}
...
Example: `project/tests/basic/vault1.hbv` builds `sat_customer_hb` from `sat_customer`.
...
Example: `project/tests/multi-satellite-bv/customer-360.hbv` → table `customer_360_bv` with 11 field mappings across 4 satellites.
...
See `project/tests/multi-satellite-bv/customer-360-external.hdv` and `.hbv` for a working example.

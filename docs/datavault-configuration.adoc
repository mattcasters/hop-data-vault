...
|Hash key data type
|Physical storage for hash keys: BINARY (recommended), HEX, or STRING.
...
* The target database connection is required for **Generate DDL**, **Debug**, and the **Data Vault Update** action.

...
The workflow drops and recreates schemas, generates CSV source files, loads CRM, then runs Data Vault Update, Business Vault Update, and Dimensional Update.
...
. Open `models/retail-warehouse.hdm` — facts `f_orders`, `f_order_lines`, conformed dimensions.

...
* `integration-tests/tests//basic/update-dm-basic-star.hwf` — basic star schema
* `integration-tests/tests//basic/update-dm-extended-catalog.hwf` — full Kimball catalog (pipeline/DDL only)

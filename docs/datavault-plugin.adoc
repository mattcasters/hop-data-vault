...
New modelers should follow link:getting-started-modeler.adoc[Getting started — Data Vault and Business Vault modeling] for a hands-on path through the sample `project/`.

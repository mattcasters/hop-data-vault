...
* Baseline catalog version: **`v1.0.0`** (seeded from `fixtures/schema-gate-baseline/` into `work/edw-catalog/catalog-versions/` by bootstrap)
* Report output path: `${PROJECT_HOME}/work/reports`
...
Generated files look like `retail-example/work/reports/retail-schema-validation.md` (and `.html`) when the gate runs.
